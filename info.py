...
STREAM_API = (environ.get('STREAM_API', '7302cc705b1aca0980fd96fd69a528100c482da3'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/baljeetsingh_11147'))
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : blgt')
...
LANGUAGES = ["panjabi", "", "tamil", "", "english", "", "hindi", "", "telugu", "", "kannada", "", "gujarati", "", "marathi", "", "punjabi", ""]
...
URL = "https://amazing-elaine-baljeetsingh-eb4f483b.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://amazing-elaine-baljeetsingh-eb4f483b.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://amazing-elaine-baljeetsingh-eb4f483b.koyeb.app/".format(FQDN)
else:
    URL = "https://amazing-elaine-baljeetsingh-eb4f483b.koyeb.app/".format(FQDN)
