...
URL = "https://movie-request-3rvz.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-request-3rvz.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-request-3rvz.onrender.com/".format(FQDN)
else:
    URL = "https://movie-request-3rvz.onrender.com/".format(FQDN)
