...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002119707654').split()] #Channel id for auto indexing ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/howtodownloadpublic/2') # How to open tutorial link for verification
