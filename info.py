...
URL = "https://ddlbot-f9033d9e053c.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ddlbot-f9033d9e053c.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ddlbot-f9033d9e053c.herokuapp.com/".format(FQDN)
else:
    URL = "https://ddlbot-f9033d9e053c.herokuapp.com/".format(FQDN)
